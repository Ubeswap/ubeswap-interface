...
import { useMinimaTrade, useUbeswapTradeExactOut } from 'components/swap/routing/hooks/useTrade'
...
export function useDerivedSwapInfo(): {
  ...
  const bestTradeExactIn = useMinimaTrade(isExactIn ? parsedAmount : undefined, outputCurrency ?? undefined)
